...
class Ui_Report(object):
    def setupUi(self, Report):
        ...
        self.widget_2.setGeometry(QtCore.QRect(30, 100, 251, 551))
        ...
        self.widget_3.setGeometry(QtCore.QRect(310, 100, 881, 101))
        self.widget_3.setStyleSheet("background-color:rgb(43, 86, 190)")
        self.widget_3.setObjectName("widget_3")
        self.label_6 = QtWidgets.QLabel(self.widget_3)
        self.label_6.setGeometry(QtCore.QRect(30, 30, 238, 28))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.widget_3)
        self.label_7.setGeometry(QtCore.QRect(40, 60, 94, 16))
        self.label_7.setObjectName("label_7")
        self.widget_4 = QtWidgets.QWidget(self.centralwidget)
        self.widget_4.setGeometry(QtCore.QRect(310, 220, 881, 131))
        self.widget_4.setStyleSheet("background-color:rgb(255, 255, 255)")
        self.widget_4.setObjectName("widget_4")
        self.label_8 = QtWidgets.QLabel(self.widget_4)
        self.label_8.setGeometry(QtCore.QRect(30, 37, 183, 22))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.widget_4)
        self.label_9.setGeometry(QtCore.QRect(40, 70, 217, 17))
        self.label_9.setObjectName("label_9")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(1060, 390, 131, 41))
